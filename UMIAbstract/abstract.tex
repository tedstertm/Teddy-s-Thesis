...
%% for use with the abstract.sty file
%% Separate abstract page for UW theses 
%% Replace the following three lines with your own data 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{MICROSCALE PRINCIPLES AND TOOLS FOR\\STUDYING CELLULAR INTERACTIONS}

\author{Jay W. Warrick}
\def\professor{Professor David J. Beebe}
\begin{document}

\maketitle
\thispagestyle{empty}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%  BEGIN VERBIAGE Replace the verbiage between here and 
%%%  end{verbiage} with your own abstract file
...
\vspace{.25truein}
%% This is for your advisor's signature}
\centerline{\rule{2.5truein}{.01truein}}
\centerline{Advisor}
\thispagestyle{empty}
\end{document}
